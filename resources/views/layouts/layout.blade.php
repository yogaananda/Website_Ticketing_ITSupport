        ...
        <ul class="space-y-3 font-medium">
            ...
            <li> 
                <a href="{{ route('it.procurements.index') }}" class="flex items-center px-3 py-2 rounded-lg transition-all group {{ isActive('it.procurements.*') ? 'bg-white text-indigo-700 shadow-sm' : 'text-gray-700 hover:bg-white/50 hover:text-indigo-700' }}">
                    <svg class="w-5 h-5 transition duration-75 {{ isActive('it.procurements.*') ? 'text-indigo-700' : 'group-hover:text-indigo-700' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                    <span class="ms-3">Permintaan Barang</span>
                </a>
            </li>
            <li class="pt-2 mt-2 border-t border-indigo-300/50">
                <p class="text-xs font-semibold text-indigo-500 uppercase px-3 mb-2">Dokumentasi</p>
            </li>
            <li> 
                <a href="{{ route('it.knowledge_base.index') }}" class="flex items-center px-3 py-2 rounded-lg transition-all group {{ isActive('it.knowledge_base.*') ? 'bg-white text-indigo-700 shadow-sm' : 'text-gray-700 hover:bg-white/50 hover:text-indigo-700' }}">
                    <svg class="w-5 h-5 transition duration-75 {{ isActive('it.knowledge_base.*') ? 'text-indigo-700' : 'group-hover:text-indigo-700' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
